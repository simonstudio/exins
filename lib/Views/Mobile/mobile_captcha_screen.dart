...
class MobileCaptchaScreen extends StatefulWidget {
  const MobileCaptchaScreen({super.key});

  @override
  State<MobileCaptchaScreen> createState() => _MobileCaptchaScreenState();
}

class _MobileCaptchaScreenState extends State<MobileCaptchaScreen> {
