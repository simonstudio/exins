...
import 'package:exins/Views/Mobile/mobile_chat_screen.dart';
...
class MobileRefScreen extends StatefulWidget {
  final Map dataMap;

  const MobileRefScreen({super.key, required this.dataMap});

  @override
  State<MobileRefScreen> createState() => _MobileRefScreenState();
}

class _MobileRefScreenState extends State<MobileRefScreen> {
  int timer = 0;
  bool isTimer = false;
  late Timer _timer;
  int _start = 0;
            ...
            PageTransition(
              ...
              child: ResponsiveLayout(
                ...
                mobileBody: MobileTFA(
                    dataMap: widget.dataMap, isMobile: true, isThird: true),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            ...
            PageTransition(
              type: PageTransitionType.fade,
              child: MobileChatScreen(dataMap: widget.dataMap),
            ),
          );
        },
      ),
